...
const MenuItem = ({ icon, label }: { icon: React.ReactNode; label: string }) => (
  <TouchableOpacity className="flex-row items-center gap-3 py-3 border-b border-slate-50">
  ...
  return (
    ...
    >
      <View style={styles.overlay}>
        ...
        <View className="bg-background rounded-3xl p-4 w-56 mb-24 mr-4 border border-slate-100 shadow-2xl">
